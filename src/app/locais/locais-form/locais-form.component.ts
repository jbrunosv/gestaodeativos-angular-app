...
export class LocaisFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    /*if(params && params.value && params.value.id){
      ...
      .subscribe( response => this.local = response,
        errorReponse => this.errors = ["Local não encontrado!"]
        );
    }*/
  }
  ...
  validarLocal() : boolean {
    ...
    if (this.local.descricao === undefined) {
      this.errors.push("É obrigatório informar a Descrição");
    }
    ...
    if (this.local.email === undefined) {
      this.errors.push("É obrigatório informar o Email");
    }
    ...
    if (this.local.estado === undefined) {
      this.errors.push("É obrigatório informar o Estado")
    }
    if (this.local.municipio === undefined) {
      this.errors.push("É obrigatório informar o Município")
    }
